...
(function () {
  ...
  document.querySelectorAll('.item-resumen').forEach(item => {
    const e1el = item.querySelector('#resultadoEstrella1');
    if (!e1el) return; // sorteo aún no celebrado
    ...
    const e1 = parseInt(e1el.textContent.trim());

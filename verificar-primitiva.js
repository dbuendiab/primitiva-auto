...
(function () {
  ...
  document.querySelectorAll('.item-resumen').forEach(item => {
    const compEl = item.querySelector('#resultadoComplementario');
    if (!compEl) return; // sorteo aún no celebrado
    ...
    const comp = parseInt(compEl.textContent.trim());
